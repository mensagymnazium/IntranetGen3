...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Attrida.AttridaComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Attrida.AttridaDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Attrida.AttridaObject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Attrida.AttridaTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Common.DateInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.CountryLocalization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Localizations.Language", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Attrida.AttridaComment", b =>
                {
                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Attrida.AttridaObject", "AttridaObject")
                        .WithMany("CommentsIncludingDeleted")
                        .HasForeignKey("AttridaObjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Security.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.Address", b =>
                {
                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Crm.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.Contact", b =>
                {
                    ...
                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Crm.Address", "ContactAddress")
                        .WithMany()
                        .HasForeignKey("ContactAddressId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Crm.Address", "RegisteredAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("MensaGymnazium.IntranetGen3.Model.Crm.CountryLocalization", b =>
                {
                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Localizations.Language", "Language")
                        .WithMany()
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MensaGymnazium.IntranetGen3.Model.Crm.Country", "Parent")
