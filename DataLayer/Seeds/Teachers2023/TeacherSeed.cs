...
public class TeacherSeed : DataSeed<Teachers2023Profile>
{
	public override void SeedData()
	{
		var teachers = new[]
		{
			...
			new Teacher() { SeededEntityId = 131, User = new User() { Email = "mensaforum.2023.006@mensagymnazium.cz", Name = "PhDr. Tomáš Sedláček, Ph.D." } },
			...
			new Teacher() { SeededEntityId = 212, User = new User() { Email = "mensaforum.2023.011@mensagymnazium.cz", Name = "doc. JUDr. Bc. Vladimír Pelc, Ph.D." } },
