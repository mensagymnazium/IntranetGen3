	...
	public class TeacherSeed : DataSeed<DemoProfile>
	{
		public override void SeedData()
		{
			var teachers = new[]
			{
				...
				new Teacher() { SeededEntityId=2805686, User=new User() { Email="demo.Seddon@example.com", Name="David J. Seddon" } },
				...
				new Teacher() { SeededEntityId=856000, User=new User() { Email="demo.James.De.Silva@example.com", Name="James De Silva" } },
				new Teacher() { SeededEntityId=10659022, User=new User() { Email="demo.Jitka.Prochazkova@example.com", Name="Jitka Procházková" } },
				new Teacher() { SeededEntityId=8258528, User=new User() { Email="demo.Katerina.Dojciakova@example.com", Name="Kateřina Dojčiaková" } },
				new Teacher() { SeededEntityId=5906515, User=new User() { Email="demo.Krystof.Kucmas@example.com", Name="Kryštof Kučmáš" } },
				new Teacher() { SeededEntityId=872777, User=new User() { Email="demo.Martin.Kalivoda@example.com", Name="Martin Kalivoda" } },
				new Teacher() { SeededEntityId=13061828, User=new User() { Email="demo.Martin.Komarek@example.com", Name="Martin Komárek" } },
				...
				new Teacher() { SeededEntityId=2188808, User=new User() { Email="demo.Petr.Kubacak@example.com", Name="Mgr. Petr Kubačák" } },
				...
				new Teacher() { SeededEntityId=9398696, User=new User() { Email="demo.Rafik.Bedretdinov@example.com", Name="PhDr. Rafik Bedretdinov, CSc." } },
				...
				new Teacher() { SeededEntityId=6273638, User=new User() { Email="demo.Katerina.Miloschewska@example.com", Name="RNDr. Kateřina Miloschewská" } },
