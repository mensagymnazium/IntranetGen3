...
public class TeacherSeed : DataSeed<Teachers2022Profile>
{
	public override void SeedData()
	{
		var teachers = new[]
		{
			new Teacher() { SeededEntityId = 111, User = new User() { Email = "mensaforum.2022.001@mensagymnazium.cz", Name = "Placeholder Placeholder" } },
			new Teacher() { SeededEntityId = 121, User = new User() { Email = "mensaforum.2022.002@mensagymnazium.cz", Name = "Jakub Železný" } },
			new Teacher() { SeededEntityId = 113, User = new User() { Email = "mensaforum.2022.003@mensagymnazium.cz", Name = "Placeholder Placeholder" } },
			...
			new Teacher() { SeededEntityId = 223, User = new User() { Email = "mensaforum.2022.015@mensagymnazium.cz", Name = "Placeholder Placeholder" } },
			...
			new Teacher() { SeededEntityId = 331, User = new User() { Email = "mensaforum.2022.025@mensagymnazium.cz", Name = "Placeholder Placeholder" } },
