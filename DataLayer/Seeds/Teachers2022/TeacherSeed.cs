...
public class TeacherSeed : DataSeed<Teachers2022Profile>
{
	public override void SeedData()
	{
		var teachers = new[]
		{
			...
			new Teacher() { SeededEntityId = 123, User = new User() { Email = "mensaforum.2022.005@mensagymnazium.cz", Name = "JUDr. Lenka Bradáčová, Ph.D." } },
			new Teacher() { SeededEntityId = 131, User = new User() { Email = "mensaforum.2022.006@mensagymnazium.cz", Name = "Bc. Filip Turek" } },
			...
			new Teacher() { SeededEntityId = 223, User = new User() { Email = "mensaforum.2022.015@mensagymnazium.cz", Name = "Ing. Dana Drábová, Ph.D., dr. H. c. mult." } },
			new Teacher() { SeededEntityId = 231, User = new User() { Email = "mensaforum.2022.016@mensagymnazium.cz", Name = "Filip Maleňák" } },
			new Teacher() { SeededEntityId = 232, User = new User() { Email = "mensaforum.2022.017@mensagymnazium.cz", Name = "Doc. PhDr. David Václavík Ph. D." } },
			...
			new Teacher() { SeededEntityId = 312, User = new User() { Email = "mensaforum.2022.020@mensagymnazium.cz", Name = "MgA. Ondřej Sokol" } },
			new Teacher() { SeededEntityId = 313, User = new User() { Email = "mensaforum.2022.021@mensagymnazium.cz", Name = "Andrea Vytlačilová" } },
			new Teacher() { SeededEntityId = 321, User = new User() { Email = "mensaforum.2022.022@mensagymnazium.cz", Name = "Mgr. Robin Kaleta" } },
			new Teacher() { SeededEntityId = 322, User = new User() { Email = "mensaforum.2022.023@mensagymnazium.cz", Name = "Bc. Jindřich Šídlo" } },
